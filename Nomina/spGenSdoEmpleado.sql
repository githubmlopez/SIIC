...
GO
CREATE PROCEDURE [dbo].[spGenSdoEmpleado] (@pIdProceso     numeric(9),        
                                           @pIdTarea       numeric(9),
...
------------------------------------------------------------------------------------------------------
  ...
  BEGIN
    EXEC spCalNumFaltas   @id_cliente,
                          @cve_empresa,
						  @id_empleado,
						  @cve_tipo_nomina,
						  @ano_periodo,
