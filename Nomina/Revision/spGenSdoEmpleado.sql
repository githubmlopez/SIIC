...
SET NOCOUNT ON
GO
IF  EXISTS( SELECT 1 FROM ADNOMINA01.sys.procedures WHERE Name =  'spGenSdoEmpleado')
BEGIN
  DROP  PROCEDURE spGenSdoEmpleado
END
GO
--EXEC spGenSdoEmpleado 1,1,'MARIO',1,'CU','NOMINA','S','201803',' ',' '
CREATE PROCEDURE [dbo].[spGenSdoEmpleado] (
@pIdProceso       int,
@pIdTarea         int,
