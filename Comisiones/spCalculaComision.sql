...
GO
ALTER PROCEDURE [dbo].[spCalculaComision] @pid_concilia_cxc  int
AS
BEGIN
...
/*  Declara cursor para leer CI_ITEM_C_X_C   */
  	...
  	declare item_cursor cursor for SELECT CVE_EMPRESA, CVE_SUBPRODUCTO, ID_ITEM, IMP_BRUTO_ITEM, IMP_DESC_COMIS1, IMP_DESC_COMIS2, F_INICIO, F_FIN, 
  	                                      CVE_VENDEDOR1, CVE_PROCESO1, CVE_ESPECIAL1, CVE_VENDEDOR2, CVE_PROCESO2, CVE_ESPECIAL2, IMP_COM_DIR1, IMP_COM_DIR2
  	                                      FROM   CI_ITEM_C_X_C
...
/* Obtiene porcentaje de comision a cobrar para el vendedor 2   */
      ...
      BEGIN  -- 13
        ...
        BEGIN
          ...
          --IF  @mes_real_pago   < @mes_inicio_cxc
          --BEGIN  -- 14
          --  set  @mes_real_pago  =  @mes_real_pago + 12
          --END -- 14
 ...
 --       set @meses_prim_pago  =  @mes_real_pago - @mes_inicio_cxc + 1
        ...
        select ' mes primer ***', CAST(@meses_prim_pago AS varchar(18))
...
/*  Genera cupones de comisión mantenimiento para Vendedor 2 */
        ...
        BEGIN  -- 17
          ...
          SELECT ' *****ENTRE A CALCULAR COMISIONES MANT ******' + CONVERT(varchar(18),@imp_neto_com_c) + ' ' + CONVERT(varchar(18),@pje_item_fact) + ' ' +
          ...
          BEGIN  -- 18
             INSERT INTO CI_CUPON_COMISION (ANO_MES,CVE_EMPRESA,SERIE,ID_CXC,ID_ITEM,NUM_PAGO,CVE_VENDEDOR,CVE_PROCESO, PJE_COMISION, IMP_CUPON, TX_NOTA )
                  VALUES(
                        ...
                        @cve_proceso2,
                        @pje_comis_ven2,
                        @imp_com_x_pagar2 * @meses_prim_pago,
                        'Pago cupon ' + CONVERT(varchar(2), @num_cupon) + '  ;  ' + CONVERT(varchar(2),@meses_prim_pago) + '  ' + 'periodos')
