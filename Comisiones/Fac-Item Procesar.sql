...
-- SELECT CONVERT(varchar(4),@ano_proc) +  replicate ('0',(02 - len(@mes_proc))) + convert(varchar, @mes_proc) 
...
--                                        Verifica que clave especial esto se utilizará solo para cierto items                                                   
                                                   ...
                                                   CONVERT(varchar(4),@ano_proc) +  replicate ('0',(02 - len(@mes_proc))) + convert(varchar, @mes_proc) >=
