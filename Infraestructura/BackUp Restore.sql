...
GO
--EXECUTE spRestore 'ADMON0120190516.BAK'
...
BEGIN
  ...
  BEGIN
    ...
    WITH FILE = 1, REPLACE,
    RECOVERY, 
    MOVE 'ADMON01' TO  N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ADMON01.mdf',
    MOVE 'ADMON01_log' TO N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ADMON01.ldf' 
