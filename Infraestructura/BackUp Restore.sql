...
--GO
--EXECUTE spRestore 'ADMON0120190306.BAK'
...
BEGIN
 ...
 --   DROP DATABASE ADMON01 
    ...
    WITH FILE = 1, REPLACE,
    RECOVERY, 
    MOVE 'ADMON01' TO  N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ADMON0101.mdf',
    MOVE 'ADMON01_log' TO N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\ADMON0101.ldf' 
