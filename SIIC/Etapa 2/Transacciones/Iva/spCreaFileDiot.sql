...
SET NOCOUNT  ON 
GO
-- exec spCreaFileDiot'CU', 'MLOPEZ', '201805', 1, 2, ' ', ' '
...
--  SELECT * FROM @TDiot
  ...
  CONVERT(VARCHAR(1),CHAR(124)) + CONVERT(VARCHAR(16),IMP_TOT_BRUTO) + CONVERT(VARCHAR(1),CHAR(124)) + CONVERT(VARCHAR(16),IMP_TOT_IVA) +
