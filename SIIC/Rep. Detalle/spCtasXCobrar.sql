...
--exec spCtasXCobrar  'CU','201801', 'P'
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE spCtasXCobrar  @pCveEmpresa varchar (4), @pAnoMes  varchar(6), @pMoneda varchar (1)
AS
BEGIN
   ...
   CONVERT(VARCHAR(12),dbo.fnObtTipoCambC(@pCveEmpresa, @pAnoMes, f.F_OPERACION)),
   ...
   CONVERT(VARCHAR(12),(dbo.fnCalculaPesosC(@pCveEmpresa, @pAnoMes,f.F_OPERACION, f.IMP_F_NETO, CVE_F_MONEDA) - dbo.fnImpLiqPesos(f.ID_CONCILIA_CXC, @pAnoMes))) AS IMP_PAGADO, 
   i.IMP_BRUTO_ITEM    
