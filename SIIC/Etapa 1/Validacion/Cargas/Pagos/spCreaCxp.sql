...
SET NOCOUNT ON
GO
IF  EXISTS( SELECT 1 FROM ADMON01.sys.procedures WHERE Name =  'spCreaCxp')
BEGIN
  DROP  PROCEDURE spCreaCxp
END
GO

--EXEC spCreaCxp 'CU','MARIO','201906',146,8137,' ',' '
CREATE PROCEDURE [dbo].[spCreaCxp]
(
